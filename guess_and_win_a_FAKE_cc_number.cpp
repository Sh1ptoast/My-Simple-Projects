...
int main() {
    ...
    cout << "Sh1ptoast INC is required by law to state that the \"credit card number\"";
    ...
    if (cin.fail()) { // if you guess letters
        ...
        cout << "Remember that Sh1ptoast INC is required by law to state that the \"credit card number\"";
        cout << " is randomly generated and not real." << endl;
    }
    return 0;
}
